        ...
        <div class="col-md-4 col-sm-6 col-12">
          <div class="gallery-item">
            ...
            <div class="image-caption">
             ...
             <button class="btn btn-success text-white" id="lihatBtn">Tambah</button>
             <button class="btn btn-warning text-white" id="lihatBtn">Edit</button>
           </li>
            </div>
          </div>
        </div>
