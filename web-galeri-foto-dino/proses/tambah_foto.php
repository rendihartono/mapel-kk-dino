...
if (isset($_POST['tambah'])) {
    ...
    if (move_uploaded_file($tmp_file, $path)) {
        $sql = "INSERT INTO foto (judul_foto, deskripsi_foto, lokasi_foto, lokasi_file, tanggal upload, id_user
    ...
    echo echo "<script>alert ('Gagal mengupload file ke folder img/. Pastikan  folder dapat ditulis.'); history.back();</script>";
}  
}       
 ?>